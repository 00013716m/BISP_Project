...
public class WeaponManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKey(KeyCode.G) || Input.GetKey(KeyCode.T)) //Hit and hold will increase the force
        {
        ...
        if (Input.GetKeyUp(KeyCode.G)) //Release will throw the lethal
        {
            if (lethalsCount > 0)
            {
                ThrowLethal();
        ...
        if (Input.GetKeyUp(KeyCode.T)) //Release will throw the lethal
        {
            if (tacticalCount > 0)
            {
                ThrowTactical();
